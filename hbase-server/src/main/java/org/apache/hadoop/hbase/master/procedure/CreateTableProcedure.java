...
public class CreateTableProcedure
  ...
  protected static void createFsLayout(final MasterProcedureEnv env,
      final HTableDescriptor hTableDescriptor, final List<HRegionInfo> newRegions)
      throws IOException {
    createFsLayout(env, hTableDescriptor, newRegions, new CreateHdfsRegions() {
      @Override
  ...
  protected static void addTableToMeta(final MasterProcedureEnv env,
      final HTableDescriptor hTableDescriptor,
      List<HRegionInfo> newRegions) throws IOException {
